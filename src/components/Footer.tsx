        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-xl font-semibold mb-4">
              Toronto&apos;s Water Damage Experts
            </h3>
            <div className="h-1 w-16 bg-white mb-6"></div>
            <p className="text-stone-300 mb-6 leading-relaxed">
              Your trusted partner in flood and water damage restoration across the Greater Toronto Area. Our rapid response team is available 24/7 to protect your property from water damage, with cutting-edge equipment and proven restoration techniques.
            </p>
            <div className="text-stone-400 text-sm">
              <p>Locally owned and operated in Toronto</p>
          ...
          <div>
            ...
            <div className="text-stone-300 space-y-4">
              <div>
                ...
                <p className="mt-2 text-white font-semibold">Emergency Response Within 30 Minutes</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-stone-700">
          <div className="flex flex-col md:flex-row justify-between items-center text-stone-400 text-sm">
            <div className="text-center md:text-left mb-4 md:mb-0">
              <p>© {new Date().getFullYear()} Toronto Flood Restoration. ALL RIGHTS RESERVED</p>
            </div>
