  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone",
      content: "+1 (647) 361-0663",
      onClick: (e: React.MouseEvent<HTMLDivElement>) => {
        copyToClipboard("+1 (647) 361-0663", true);
      }
    },
    {
      icon: Mail,
      title: "Email",
      content: "office@flood.ltd",
      onClick: (e: React.MouseEvent<HTMLDivElement>) => {
        copyToClipboard("office@flood.ltd", false);
      }
    },
    {
      icon: Clock,
      ...
      <section className="relative bg-gradient-to-b from-[#8B2635] to-[#6B1D29] py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-stone-300 max-w-2xl mx-auto">
            Professional restoration services across the GTA
          </p>
        </div>
      </section>
        ...
        <div className="bg-white rounded-xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center items-center gap-4">
              ...
              <p className="text-[#44403C]">Fast response across the GTA</p>
              <div className="h-px w-12 bg-[#8B2635]" />
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-stone-200 rounded-lg focus:ring-2 focus:ring-[#8B2635] focus:border-[#8B2635] transition-colors"
                required
                placeholder="Please describe your emergency or restoration needs..."
              />
            </div>
